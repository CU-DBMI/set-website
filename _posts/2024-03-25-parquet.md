...
Parquet columns are organized into row groups.
Each row group includes chunks of columns in the form of pages.
Row groups and column pages within them are configurable and may change depending on the configuration of your Parquet client.
