...
{% include figure.html image="images/linkml-coffee-queue-erdiagram.png" caption="Mermaid ER diagram generated from the LinkML schema." %}

Generated PlantUML (from `linkml generate plantuml` on this schema):

{% include figure.html image="images/linkml-coffee-queue-plantuml.png" caption="PlantUML class diagram generated from the same LinkML schema." %}
